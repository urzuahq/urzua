...
`docs/specs/SPEC-19-agents-md-agent-instructions-for-this-repo.md` governs this file: what belongs
in it and why, and its revision log is where this file's own change history lives, since this prose
carries none itself. Any substantive edit here adds a matching entry there, in the same PR.
