# 0015 — fix writes Drift detected automatically
...
ADR-0032 explicitly named this as separate follow-up work, not implied by drift detection landing in check alone.
