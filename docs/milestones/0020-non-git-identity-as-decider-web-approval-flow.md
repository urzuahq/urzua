# 0020 — Non-git identity as Decider / web approval flow
...
Let a non-technical Decider (a manager, a compliance officer) approve via something other than a git-authored commit.
