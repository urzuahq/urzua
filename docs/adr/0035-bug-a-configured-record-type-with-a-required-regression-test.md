# 0035 — `bug`: a configured record type requiring a named regression test
...
> Derives-from: ADR-0034 (Accepted)
...
- ADR-0034 — the `milestone` type this is a sibling of, and the reasoning this ADR follows.
