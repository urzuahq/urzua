...
`urzua-io` ([ADR-5](ADR-5-a-fifth-crate-for-io-resolves-the-purity-contradiction.md)) needs to
...
true`) already optimizes for startup latency and binary size over compile time — [ADR-1](ADR-1-rust-as-implementation-language.md)
...
- [ADR-5](ADR-5-a-fifth-crate-for-io-resolves-the-purity-contradiction.md) — the crate this
  decision lives inside.
- [ADR-1](ADR-1-rust-as-implementation-language.md) — the commit-hot-path startup argument this
  decision protects.
