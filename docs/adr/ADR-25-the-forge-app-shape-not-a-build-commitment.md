...
RFC-14 proposes a forge app as the destination for governance-event collection (RFC-3 §5
...
- Real open questions stay open, not resolved by this ADR: whether the app is self-hostable or
  ...
  unanswered escalation question (Q1) — it explicitly should not, per RFC-14 §5's own caution
...
- RFC-14 — the proposal this decides.
- RFC-3 §5 — the collection-needs-a-destination argument this shape answers.
- RFC-2 §2 — the identity tiering an authenticated forge account would improve on.
