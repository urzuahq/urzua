...
SPEC-3 flagged "does the config need a version field?" as open, noting it costs nothing now and
...
repos this project doesn't control. This is exactly the "cheap now, unaddable later" case SPEC-3
already named.
