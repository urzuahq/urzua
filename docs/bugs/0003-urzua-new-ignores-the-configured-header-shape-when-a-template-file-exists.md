# 0003 — urzua new ignores the configured header_shape when a template file exists

> Status: Open
> Stable-Id: 01M1Y7W55XWYY7DJF2GF8PZX9T
> Found-in: found live while writing ADR-0033 -- flipped adr's header_shape to yaml-frontmatter and ran `urzua new adr`, expecting YAML frontmatter output, and got blockquote content back unchanged
...
- ADR-0027 -- the original template-vs-synthesis decision this defect lives inside.
- ADR-0033 -- where this was found live, and which explicitly named this as a required fix before
