...
> | 2026-09-23 | Status moved to `Fixed`. The 2026-09-11 backfill's "none remain" claim was not quite true: `ADR-46` and `RFC-27`, both dated 2026-09-11, still carried the quoted `@`-prefixed form -- created same-day as the backfill and missed by it, not a later regression. Both corrected to the bare, unquoted login; a fresh corpus-wide grep confirms none remain now. | **substantive** |
